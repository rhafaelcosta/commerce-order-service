...
import com.github.rhafaelcosta.commerce.order.core.ports.in.customer.ForQueryingCustomers;
import com.github.rhafaelcosta.commerce.order.core.ports.out.customer.ForNotifyingCustomers;
import com.github.rhafaelcosta.commerce.order.infrastructure.adapters.in.listener.customer.CustomerEventListener;
...
class CustomerManagementApplicationServiceIT extends AbstractApplicationIT {
    ...
    void shouldRegister() {
        ...
        Mockito.verify(customerNotificationApplicationService).notifyNewRegistration(Mockito.any(ForNotifyingCustomers.NotifyNewRegistrationInput.class));
    }
