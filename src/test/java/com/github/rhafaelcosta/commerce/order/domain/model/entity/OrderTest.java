...
import com.github.rhafaelcosta.commerce.order.domain.model.exception.OrderInvalidShippingDeliveryDateException;
import com.github.rhafaelcosta.commerce.order.domain.model.exception.OrderStatusCannotBeChangedException;
import com.github.rhafaelcosta.commerce.order.domain.model.exception.ProductOutOfStockException;
...
class OrderTest {
    ...
    void shouldCalculateTotals() {
        ...
        Assertions.assertThat(order.totalAmount()).isEqualTo(new Money("500"));
