package com.github.rhafaelcosta.commerce.order.infrastructure.adapters.in.web.shoppincart;
...
class ShoppingCartControllerIT extends AbstractPresentationIT {
    ...
    void shouldCreateShoppingCart() {
        String json = CommercePlaftformResourceUtils.readContent("json/create-shopping-cart.json");
    ...
    void shouldAddProductToShoppingCart() {
        String json = CommercePlaftformResourceUtils.readContent("json/add-product-to-shopping-cart.json");
        RestAssured
            .given()
                .accept(MediaType.APPLICATION_JSON_VALUE)
                .contentType(MediaType.APPLICATION_JSON_VALUE)
