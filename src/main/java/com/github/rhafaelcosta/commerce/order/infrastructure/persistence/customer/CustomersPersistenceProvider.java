package com.github.rhafaelcosta.commerce.order.infrastructure.persistence.customer;
...
public class CustomersPersistenceProvider implements Customers {
    ...
    public void add(Customer aggregateRoot) {
        ...
        persistenceRepository.findById(customerId)
                .ifPresentOrElse(
                        (CustomerPersistenceEntity persistenceEntity) -> update(aggregateRoot, persistenceEntity),
